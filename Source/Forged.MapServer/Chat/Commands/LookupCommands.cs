...
internal class LookupCommands
{
    ...
    private static bool HandleLookupTeleCommand(CommandHandler handler, string namePart)
    {
        ...
        foreach (var tele in handler.ClassFactory.Resolve<GameTeleObjectCache>().GameTeleStorage)
        {
    ...
    private class LookupItemCommands
    {
        ...
        {
            var itemTemplate = handler.ClassFactory.Resolve<ItemTemplateCache>().GetItemTemplate(id);

...
public class InstanceLockManager
{
    ...
    public InstanceLockManager(CharacterDatabase characterDatabase, IConfiguration configuration, WorldManager worldManager, CliDB cliDB, MapManager mapManager)
    {

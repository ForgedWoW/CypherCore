...
internal class CometStormEvent : BasicEvent
{
    ...
    public override bool Execute(ulong etime, uint pTime)
    {
        ...
        _caster.SpellFactory.CastSpell(destPosition, MageSpells.CometStormVisual, new CastSpellExtraArgs(TriggerCastFlags.IgnoreCastInProgress).SetOriginalCastId(_originalCastId));
        ++_count;

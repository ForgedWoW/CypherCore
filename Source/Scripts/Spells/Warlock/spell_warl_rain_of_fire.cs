...
internal class SpellWarlRainOfFire : AuraScript, IHasAuraEffects, IAuraOnRemove
{
    ...
    private void HandleDummyTick(AuraEffect aurEff)
    {
        ...
        foreach (var insideTargetGuid in targetsInRainOfFire)
        {
            ...
            if (insideTarget)
                ...
                {
                    Target.SpellFactory.CastSpell(insideTarget, WarlockSpells.RAIN_OF_FIRE_DAMAGE, true);

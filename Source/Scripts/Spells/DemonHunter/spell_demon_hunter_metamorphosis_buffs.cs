...
[SpellScript(162264)]
public class SpellDemonHunterMetamorphosisBuffs : AuraScript, IHasAuraEffects
{
    ...
    private void OnRemove(AuraEffect unnamedParameter, AuraEffectHandleModes unnamedParameter2)
    {
        ...
        if (caster.HasAura(DemonHunterSpells.DEMONIC_ORIGINS))
            caster.SpellFactory.CastSpell(caster, DemonHunterSpells.DEMONIC_ORIGINS_BUFF, true);
    }
}
...
[SpellScript(32379)]
public class SpellPriShadowWordDeath : SpellScript, IHasSpellEffects
{
    ...
    private void HandleDamage(int effIndex)
    {
        ...
        if (target != null)
        {
            if (target.Health < HitDamage)
                Caster.SpellFactory.CastSpell(Caster, PriestSpells.SHADOW_WORD_DEATH_ENERGIZE_KILL, true);
            else

...
[SpellScript(137639)]
public class SpellMonkStormEarthAndFire : AuraScript, IHasAuraEffects
{
    ...
    {
        var target = Target;
        target.SpellFactory.CastSpell(target, StormEarthAndFireSpells.SEF_STORM_VISUAL, true);
        target.SpellFactory.CastSpell(target, StormEarthAndFireSpells.SEF_SUMMON_EARTH, true);
        target.SpellFactory.CastSpell(target, StormEarthAndFireSpells.SEF_SUMMON_FIRE, true);
    }

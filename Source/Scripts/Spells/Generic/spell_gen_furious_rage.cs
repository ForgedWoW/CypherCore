...
internal class SpellGenFuriousRage : AuraScript, IHasAuraEffects
{
    ...
    {
        var target = Target;
        target.TextEmote(EmoteIds.FURIOUS_RAGE, target, false);
    }
    ...
    private void AfterRemove(AuraEffect aurEff, AuraEffectHandleModes mode)
    {
        ...
        target.SpellFactory.CastSpell(target, GenericSpellIds.EXHAUSTION, true);
    }
}
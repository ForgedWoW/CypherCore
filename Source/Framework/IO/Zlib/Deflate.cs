...
public static partial class ZLib
{
    ...
    private static uint longest_match(deflate_state s, uint cur_match)
    {
        ...
        do
        {
            ...
            do { } while (scan[++scan_ind] == match[++match_ind] &&
    ...
    {
        public readonly ushort good_length; // reduce lazy search above this match length
        public readonly ushort max_lazy;    // do not perform lazy search above this match length
        public readonly ushort nice_length; // quit search above this match length
        public readonly ushort max_chain;
        public readonly compress_func func;

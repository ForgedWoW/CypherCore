...
public sealed class StringArguments
{
    ...
    public char NextChar(string delimiters = " ")
    {
        ...
        if (char.TryParse(Current, out var value))
            return value;
    ...
    public byte NextByte(string delimiters = " ")
    {
        ...
        if (byte.TryParse(Current, out var value))
            return value;
    ...
    public sbyte NextSByte(string delimiters = " ")
    {
        ...
        if (sbyte.TryParse(Current, out var value))
            return value;
    ...
    public ushort NextUInt16(string delimiters = " ")
    {
        ...
        if (ushort.TryParse(Current, out var value))
            return value;
    ...
    public short NextInt16(string delimiters = " ")
    {
        ...
        if (short.TryParse(Current, out var value))
            return value;
    ...
    public uint NextUInt32(string delimiters = " ")
    {
        ...
        if (uint.TryParse(Current, out var value))
            return value;
    ...
    public ulong NextUInt64(string delimiters = " ")
    {
        ...
        if (ulong.TryParse(Current, out var value))
            return value;
    ...
    public long NextInt64(string delimiters = " ")
    {
        ...
        if (long.TryParse(Current, out var value))
            return value;
    ...
    public float NextSingle(string delimiters = " ")
    {
        ...
        if (float.TryParse(Current, out var value))
            return value;

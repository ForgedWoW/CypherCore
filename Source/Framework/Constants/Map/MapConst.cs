...
public class MapConst
{
    ...
    public const float DefaultCollesionHeight = 2.03128f;
    ...
    public const uint MapAreaMagic = 0x41455241;

    public const float MapHalfSize = (MapSize / 2);

    //"AREA";
    public const uint MapHeightMagic = 0x5447484D;

    //"MHGT";
    public const uint MapLiquidMagic = 0x51494C4D;

    public const uint MapMagic = 0x5350414D;
    ...
    public const uint MapVersionMagic2 = 0x302E3276;

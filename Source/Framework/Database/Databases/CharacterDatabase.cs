...
public class CharacterDatabase : MySqlBase<CharStatements>
{
    ...
    public override void PreparedStatements()
    {
        ...
        PrepareStatement(CharStatements.INS_CHAR_SKILLS, "INSERT IGNORE INTO character_skills (guid, skill, value, max, professionSlot) VALUES (?, ?, ?, ?, ?)");
        ...
        PrepareStatement(CharStatements.INS_CHAR_SPELL, "INSERT IGNORE INTO character_spell (guid, spell, active, disabled) VALUES (?, ?, ?, ?)");

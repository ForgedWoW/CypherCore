...
public class HotfixDatabase : MySqlBase<HotfixStatements>
{
    ...
    public override void PreparedStatements()
    {
        ...
        // AreaPOI
        PrepareStatement(HotfixStatements.SEL_AREA_POI,
                         "SELECT Name, Description, ID, Pos1, Pos2, Pos3, PortLocID, PlayerConditionID, UiTextureAtlasMemberID, " +
        ...
        // AreaPOIState.db2
        PrepareStatement(HotfixStatements.SEL_AREA_POI_STATE,
                         "SELECT ID, Description, WorldStateValue, IconEnumValue, UiTextureAtlasMemberID, AreaPoiID" +
        ...
        PrepareStatement(HotfixStatements.SEL_GARR_TALENT_TREE,
                         "SELECT ID, Title, GarrTypeID, ClassID, MaxTiers, UiOrder, Flags, UiTextureKitID, " +
        ...
        PrepareStatement(HotfixStatements.SEL_TRAIT_SYSTEM,
                         "SELECT ID, `Field_10_0_0_44795_001`, WidgetSetID FROM trait_system" +
                         "  WHERE (`VerifiedBuild` > 0) = ?");
